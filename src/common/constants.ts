...
export const ALL_REGEX = /\b(all)(\b|\?)/i;

export const BERANEK_REGEX = /\b(beranek)(\b|\?)/i;
...
export const LLOYDS_REGEX = /\b(lloyds|loyds)(\b|\?)/i;

export const NAMEDAY_REGEX = /\b(svatek|meniny|nameday|name day)(\b|\?)/i;

export const NEPAL_REGEX = /\b(nepal)(\b|\?)/i;
